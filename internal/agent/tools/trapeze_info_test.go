...
func TestTrapezeInfo_MinimalConfig(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
	})
	output := buildTrapezeInfo(cfg, nil, nil, nil, nil)
...
func TestTrapezeInfo_ConfigFiles(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(
		&config.Config{Providers: csync.NewMap[string, config.ProviderConfig]()},
		"/home/user/.config/trapeze/trapeze.json",
		"/project/.trapeze/trapeze.json",
	)
	output := buildTrapezeInfo(cfg, nil, nil, nil, nil)
	require.Contains(t, output, "[config_files]")
	require.Contains(t, output, "/home/user/.config/trapeze/trapeze.json")
	require.Contains(t, output, "/project/.trapeze/trapeze.json")
}

func TestTrapezeInfo_Models(t *testing.T) {
	t.Parallel()
...
func TestTrapezeInfo_Providers(t *testing.T) {
	t.Parallel()
...
func TestTrapezeInfo_DisabledProvidersOmitted(t *testing.T) {
	t.Parallel()
...
func TestTrapezeInfo_LSPStates(t *testing.T) {
	t.Parallel()
	...
	output := buildTrapezeInfo(cfg, mgr, nil, nil, nil)
...
func TestTrapezeInfo_MCPStates(t *testing.T) {
	t.Parallel()
...
func TestTrapezeInfo_YoloMode(t *testing.T) {
	t.Parallel()
...
func TestTrapezeInfo_AllowedTools(t *testing.T) {
	t.Parallel()
...
func TestTrapezeInfo_DisabledTools(t *testing.T) {
	t.Parallel()
...
func TestTrapezeInfo_Options(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
		Options: &config.Options{
			DataDirectory:        "/Users/user/project/.trapeze",
			Debug:                true,
	...
	require.Contains(t, output, "data_directory = /Users/user/project/.trapeze")
	require.Contains(t, output, "debug = true")
}

func TestTrapezeInfo_AutoSummarizeInversion(t *testing.T) {
	t.Parallel()
	...
	outputFalse := buildTrapezeInfo(cfgFalse, nil, nil, nil, nil)
	...
	outputTrue := buildTrapezeInfo(cfgTrue, nil, nil, nil, nil)
	require.Contains(t, outputTrue, "auto_summarize = true")
}

func TestTrapezeInfo_NoSecrets(t *testing.T) {
	t.Parallel()
...
func TestTrapezeInfo_DeterministicOrdering(t *testing.T) {
	t.Parallel()
...
func TestTrapezeInfo_EmptySectionsOmitted(t *testing.T) {
	t.Parallel()
...
func TestTrapezeInfo_ConfigStaleness_Clean(t *testing.T) {
	t.Parallel()

	dir := t.TempDir()
	configPath := filepath.Join(dir, "trapeze.json")
	...
	output := buildTrapezeInfo(store, nil, nil, nil, nil)
...
func TestTrapezeInfo_ConfigStaleness_Dirty(t *testing.T) {
	t.Parallel()
...
func TestTrapezeInfo_ConfigStaleness_MissingPath(t *testing.T) {
	t.Parallel()
...
func TestTrapezeInfo_Skills_NoSkills(t *testing.T) {
	t.Parallel()
...
func TestTrapezeInfo_Skills_MixedLoadedUnloaded(t *testing.T) {
	t.Parallel()

	allSkills := []*skills.Skill{
		{Name: "go-doc", Builtin: false},
		{Name: "bash", Builtin: false},
		{Name: "trapeze-config", Builtin: true},
	}
	activeSkills := allSkills

	tracker := skills.NewTracker(activeSkills)
	tracker.MarkLoaded("bash")
	tracker.MarkLoaded("trapeze-config")

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
	})
	output := buildTrapezeInfo(cfg, nil, allSkills, activeSkills, tracker)
	require.Contains(t, output, "[skills]")
	require.Contains(t, output, "bash = user, loaded")
	require.Contains(t, output, "trapeze-config = builtin, loaded")
	require.Contains(t, output, "go-doc = user, unloaded")
}

func TestTrapezeInfo_Skills_DisabledSkills(t *testing.T) {
	t.Parallel()
	...
	require.Contains(t, output, "trapeze-config = builtin, unloaded")
	require.Contains(t, output, "image-convert = user, disabled")
}

func TestTrapezeInfo_Skills_Ordering(t *testing.T) {
	t.Parallel()
...
func TestTrapezeInfo_Skills_BuiltinOrigin(t *testing.T) {
	t.Parallel()
...
func TestTrapezeInfo_Hooks(t *testing.T) {
	t.Parallel()
...
func TestTrapezeInfo_Hooks_NoHooks(t *testing.T) {
	t.Parallel()
