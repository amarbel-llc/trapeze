...
import (
	...
	_ "github.com/amarbel-llc/trapeze/internal/swagger"
...
func DefaultHost() string {
	...
	if err == nil && usr.Uid != "" {
		sock = fmt.Sprintf("trapeze-%s.sock", usr.Uid)
	}
...
// Server represents a Trapeze server bound to a specific address.
type Server struct {
