...
var logsCmd = &cobra.Command{
	Use:   "logs",
	Short: "View trapeze logs",
	Long:  `View the logs generated by Trapeze. This command allows you to see the log output for debugging and monitoring.`,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		logsFile := filepath.Join(cfg.Config().Options.DataDirectory, "logs", "trapeze.log")
		_, err = os.Stat(logsFile)
		if os.IsNotExist(err) {
			log.Warn("Looks like you are not in a trapeze project. No logs found.")
			return nil
		}
