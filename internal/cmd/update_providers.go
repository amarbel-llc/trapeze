...
trapeze update-providers https://example.com/providers.json
...
trapeze update-providers --source=hyper

# Update Hyper from a custom URL
trapeze update-providers --source=hyper https://hyper.example.com
`,
