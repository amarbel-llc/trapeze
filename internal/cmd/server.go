...
var serverCmd = &cobra.Command{
	Use:   "server",
	Short: "Start the Trapeze server",
	RunE: func(cmd *cobra.Command, _ []string) error {
		...
		logFile := filepath.Join(config.GlobalCacheDir(), "server-"+safeHostName(hostURL), "trapeze.log")

		if term.IsTerminal(os.Stderr.Fd()) {
			trapezelog.Setup(logFile, debug, os.Stderr)
		} else {
		...
		slog.Info("Starting Trapeze server...", "addr", serverHost)
